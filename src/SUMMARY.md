...
- [Getting Started with Seahorse](./getting-started-with-seahorse/getting-started-with-seahorse.md)
  - [Poll App](./getting-started-with-seahorse/poll-app/poll-app.md)
    - [Initializing the project](./getting-started-with-seahorse/poll-app/initialize-project.md)
    - [Add Accounts](./getting-started-with-seahorse/poll-app/add-accounts.md)
    - [Add Instructions](./getting-started-with-seahorse/poll-app/add-instructions.md)
